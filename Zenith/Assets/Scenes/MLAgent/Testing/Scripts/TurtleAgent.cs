...
public class TurtleAgent : Agent
{
    ...
    private void SpawnObjects()
    {
        ...
        float randomDist = Random.Range(1f, 2.5f);

        Vector3 goalPos = transform.localPosition + randomDir * randomDist;
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        float turtleRotation_norm = (transform.localRotation.eulerAngles.y / 360f) * 2f - 1f;
        ...
        sensor.AddObservation(turtleRotation_norm);
    }
